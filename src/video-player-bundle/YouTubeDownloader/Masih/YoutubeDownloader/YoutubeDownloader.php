...
namespace VideoPlayerBundle\YouTubeDownloader\Masih\YoutubeDownloader;

use VideoPlayerBundle\YouTubeDownloader\Masih\YoutubeDownloader\Mp4\MediaTypes;
use VideoPlayerBundle\YouTubeDownloader\Masih\YoutubeDownloader\Mp4\Mp4;
...
EOF;
	...
	protected function downloadFile($url, $file, callable $onProgress, callable $onFinish)
	{
		...
		$videoFile = fopen($video_file[1], 'w');
		$options = array(
			'sink' => $videoFile,
			'verify' => false,
			'timeout' => 0,

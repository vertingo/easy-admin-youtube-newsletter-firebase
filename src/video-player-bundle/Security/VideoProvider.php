...
namespace VideoPlayerBundle\Security;

use VideoPlayerBundle\Security\VideoProviderInterface;
use VideoPlayerBundle\Exception\UnsupportedVideoException;
use VideoPlayerBundle\Exception\TitleNotFoundException;
use VideoPlayerBundle\Model\VideoInterface as SecurityVideoInterface;
use VideoPlayerBundle\Model\VideoInterface;
use VideoPlayerBundle\Model\VideoManagerInterface;

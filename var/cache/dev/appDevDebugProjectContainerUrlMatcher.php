    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/en')) {
            ...
            if (0 === strpos($pathinfo, '/en/newsletter')) {
                ...
                elseif (0 === strpos($pathinfo, '/en/newsletters')) {
                    if (0 === strpos($pathinfo, '/en/newsletters/design')) {
                        // en__RG__ibrows_newsletter_design_index
                        if ('/en/newsletters/design' === $trimmedPathinfo) {
                            if (substr($pathinfo, -1) !== '/') {
                                return $this->redirect($rawPathinfo.'/', 'en__RG__ibrows_newsletter_design_index');
                            }

                            return array (  '_controller' => 'NewslettersBundle\\Controller\\DesignController::indexAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_design_index',);
                        }

                        // en__RG__ibrows_newsletter_design_list
                        if ('/en/newsletters/design/list' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\DesignController::listAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_design_list',);
                        }

                        // en__RG__ibrows_newsletter_design_create
                        if ('/en/newsletters/design/create' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\DesignController::createAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_design_create',);
                        }

                        // en__RG__ibrows_newsletter_design_edit
                        if (0 === strpos($pathinfo, '/en/newsletters/design/edit') && preg_match('#^/en/newsletters/design/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'en__RG__ibrows_newsletter_design_edit')), array (  '_controller' => 'NewslettersBundle\\Controller\\DesignController::editAction',  '_locale' => 'en',));
                        }

                        // en__RG__ibrows_newsletter_design_show
                        if (0 === strpos($pathinfo, '/en/newsletters/design/show') && preg_match('#^/en/newsletters/design/show/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'en__RG__ibrows_newsletter_design_show')), array (  '_controller' => 'NewslettersBundle\\Controller\\DesignController::showAction',  '_locale' => 'en',));
                        }

                    }

                    // en__RG__ibrows_newsletter_mandant_edit
                    if ('/en/newsletters/mandant/edit' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\MandantController::editAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_mandant_edit',);
                    }

                    // en__RG__ibrows_newsletter_index
                    if ('/en/newsletters' === $trimmedPathinfo) {
                        if (substr($pathinfo, -1) !== '/') {
                            return $this->redirect($rawPathinfo.'/', 'en__RG__ibrows_newsletter_index');
                        }

                        return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::indexAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_index',);
                    }

                    // en__RG__ibrows_newsletter_list
                    if ('/en/newsletters/list' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::listAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_list',);
                    }

                    if (0 === strpos($pathinfo, '/en/newsletters/edit')) {
                        // en__RG__ibrows_newsletter_edit_redirection
                        if (0 === strpos($pathinfo, '/en/newsletters/edit/redirection') && preg_match('#^/en/newsletters/edit/redirection/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'en__RG__ibrows_newsletter_edit_redirection')), array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::editredirectionAction',  '_locale' => 'en',));
                        }

                        // en__RG__ibrows_newsletter_edit
                        if ('/en/newsletters/edit' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::editAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_edit',);
                        }

                    }

                    // en__RG__ibrows_newsletter_create
                    if ('/en/newsletters/create' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::createrediractionAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_create',);
                    }

                    // en__RG__ibrows_newsletter_meta
                    if ('/en/newsletters/meta' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::metaAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_meta',);
                    }

                    if (0 === strpos($pathinfo, '/en/newsletters/s')) {
                        if (0 === strpos($pathinfo, '/en/newsletters/subscriber')) {
                            // en__RG__ibrows_newsletter_subscriber
                            if ('/en/newsletters/subscriber' === $pathinfo) {
                                return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::subscriberAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_subscriber',);
                            }

                            // en__RG__ibrows_newsletter_subscriber_list
                            if ('/en/newsletters/subscriber/list' === $pathinfo) {
                                return array (  '_controller' => 'NewslettersBundle\\Controller\\SubscriberController::listAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_subscriber_list',);
                            }

                        }

                        // en__RG__ibrows_newsletter_summary
                        if ('/en/newsletters/summary' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::summaryAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_summary',);
                        }

                        // en__RG__ibrows_newsletter_settings
                        if ('/en/newsletters/settings' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::settingsAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_settings',);
                        }

                        // en__RG__ibrows_newsletter_send
                        if ('/en/newsletters/send' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::sendAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_send',);
                        }

                        // en__RG__ibrows_newsletter_statistic_log_read
                        if (0 === strpos($pathinfo, '/en/newsletters/statistic/log/read') && preg_match('#^/en/newsletters/statistic/log/read/(?P<mandantHash>[^/]++)/(?P<newsletterHash>[^/]++)/(?P<subscriberHash>[^/]++)$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'en__RG__ibrows_newsletter_statistic_log_read')), array (  '_controller' => 'NewslettersBundle\\Controller\\StatisticController::logreadAction',  '_locale' => 'en',));
                        }

                        // en__RG__ibrows_newsletter_statistic_show
                        if (0 === strpos($pathinfo, '/en/newsletters/statistic/show') && preg_match('#^/en/newsletters/statistic/show/(?P<newsletterId>[^/]++)$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'en__RG__ibrows_newsletter_statistic_show')), array (  '_controller' => 'NewslettersBundle\\Controller\\StatisticController::showAction',  '_locale' => 'en',));
                        }

                    }

                    // en__RG__ibrows_newsletter_generate_mail_jobs
                    if ('/en/newsletters/generate/mailjobs' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::generateMailJobsAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_generate_mail_jobs',);
                    }

                    if (0 === strpos($pathinfo, '/en/newsletters/render/show')) {
                        // en__RG__ibrows_newsletter_render_overview
                        if (preg_match('#^/en/newsletters/render/show/(?P<mandantHash>[^/]++)/(?P<newsletterHash>[^/]++)/(?P<subscriberHash>[^/]++)$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'en__RG__ibrows_newsletter_render_overview')), array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterRenderingController::showAction',  '_locale' => 'en',));
                        }

                        // en__RG__ibrows_newsletter_render_design
                        if (0 === strpos($pathinfo, '/en/newsletters/render/show/design') && preg_match('#^/en/newsletters/render/show/design/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'en__RG__ibrows_newsletter_render_design')), array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterRenderingController::showDesignPreviewAction',  '_locale' => 'en',));
                        }

                    }

                    // en__RG__ibrows_newsletter_provider_view_add
                    if ('/en/newsletters/provider/view/add' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\ProviderController::editViewAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_provider_view_add',);
                    }

                    if (0 === strpos($pathinfo, '/en/newsletters/provider/block')) {
                        // en__RG__ibrows_newsletter_blockmetadata_edit
                        if ('/en/newsletters/provider/blockmetadataedit' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\ProviderController::blockmetadataeditAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_blockmetadata_edit',);
                        }

                        // en__RG__ibrows_newsletter_provider_block_position_update
                        if ('/en/newsletters/provider/blockposition/update' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\ProviderController::blockPositionUpdateAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_provider_block_position_update',);
                        }

                        // en__RG__ibrows_newsletter_provider_block_remove
                        if ('/en/newsletters/provider/block/remove' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\ProviderController::blockRemoveAction',  '_locale' => 'en',  '_route' => 'en__RG__ibrows_newsletter_provider_block_remove',);
                        }

                    }

                    // en__RG__ibrows_newsletter_unsubscribe
                    if (0 === strpos($pathinfo, '/en/newsletters/unsubscribe/do') && preg_match('#^/en/newsletters/unsubscribe/do/(?P<mandantHash>[^/]++)/(?P<newsletterHash>[^/]++)/(?P<subscriberHash>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'en__RG__ibrows_newsletter_unsubscribe')), array (  '_controller' => 'NewslettersBundle\\Controller\\UnsubscribeController::unsubscribeAction',  '_locale' => 'en',));
                    }
        ...
        if (0 === strpos($pathinfo, '/newsletter')) {
            ...
            elseif (0 === strpos($pathinfo, '/newsletters')) {
                if (0 === strpos($pathinfo, '/newsletters/design')) {
                    // fr__RG__ibrows_newsletter_design_index
                    if ('/newsletters/design' === $trimmedPathinfo) {
                        if (substr($pathinfo, -1) !== '/') {
                            return $this->redirect($rawPathinfo.'/', 'fr__RG__ibrows_newsletter_design_index');
                        }

                        return array (  '_controller' => 'NewslettersBundle\\Controller\\DesignController::indexAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_design_index',);
                    }

                    // fr__RG__ibrows_newsletter_design_list
                    if ('/newsletters/design/list' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\DesignController::listAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_design_list',);
                    }

                    // fr__RG__ibrows_newsletter_design_create
                    if ('/newsletters/design/create' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\DesignController::createAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_design_create',);
                    }

                    // fr__RG__ibrows_newsletter_design_edit
                    if (0 === strpos($pathinfo, '/newsletters/design/edit') && preg_match('#^/newsletters/design/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fr__RG__ibrows_newsletter_design_edit')), array (  '_controller' => 'NewslettersBundle\\Controller\\DesignController::editAction',  '_locale' => 'fr',));
                    }

                    // fr__RG__ibrows_newsletter_design_show
                    if (0 === strpos($pathinfo, '/newsletters/design/show') && preg_match('#^/newsletters/design/show/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fr__RG__ibrows_newsletter_design_show')), array (  '_controller' => 'NewslettersBundle\\Controller\\DesignController::showAction',  '_locale' => 'fr',));
                    }

                }

                // fr__RG__ibrows_newsletter_mandant_edit
                if ('/newsletters/mandant/edit' === $pathinfo) {
                    return array (  '_controller' => 'NewslettersBundle\\Controller\\MandantController::editAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_mandant_edit',);
                }

                // fr__RG__ibrows_newsletter_index
                if ('/newsletters' === $trimmedPathinfo) {
                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($rawPathinfo.'/', 'fr__RG__ibrows_newsletter_index');
                    }

                    return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::indexAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_index',);
                }

                // fr__RG__ibrows_newsletter_list
                if ('/newsletters/list' === $pathinfo) {
                    return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::listAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_list',);
                }

                if (0 === strpos($pathinfo, '/newsletters/edit')) {
                    // fr__RG__ibrows_newsletter_edit_redirection
                    if (0 === strpos($pathinfo, '/newsletters/edit/redirection') && preg_match('#^/newsletters/edit/redirection/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fr__RG__ibrows_newsletter_edit_redirection')), array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::editredirectionAction',  '_locale' => 'fr',));
                    }

                    // fr__RG__ibrows_newsletter_edit
                    if ('/newsletters/edit' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::editAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_edit',);
                    }

                }

                // fr__RG__ibrows_newsletter_create
                if ('/newsletters/create' === $pathinfo) {
                    return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::createrediractionAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_create',);
                }

                // fr__RG__ibrows_newsletter_meta
                if ('/newsletters/meta' === $pathinfo) {
                    return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::metaAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_meta',);
                }

                if (0 === strpos($pathinfo, '/newsletters/s')) {
                    if (0 === strpos($pathinfo, '/newsletters/subscriber')) {
                        // fr__RG__ibrows_newsletter_subscriber
                        if ('/newsletters/subscriber' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::subscriberAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_subscriber',);
                        }

                        // fr__RG__ibrows_newsletter_subscriber_list
                        if ('/newsletters/subscriber/list' === $pathinfo) {
                            return array (  '_controller' => 'NewslettersBundle\\Controller\\SubscriberController::listAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_subscriber_list',);
                        }

                    }

                    // fr__RG__ibrows_newsletter_summary
                    if ('/newsletters/summary' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::summaryAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_summary',);
                    }

                    // fr__RG__ibrows_newsletter_settings
                    if ('/newsletters/settings' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::settingsAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_settings',);
                    }

                    // fr__RG__ibrows_newsletter_send
                    if ('/newsletters/send' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::sendAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_send',);
                    }

                    // fr__RG__ibrows_newsletter_statistic_log_read
                    if (0 === strpos($pathinfo, '/newsletters/statistic/log/read') && preg_match('#^/newsletters/statistic/log/read/(?P<mandantHash>[^/]++)/(?P<newsletterHash>[^/]++)/(?P<subscriberHash>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fr__RG__ibrows_newsletter_statistic_log_read')), array (  '_controller' => 'NewslettersBundle\\Controller\\StatisticController::logreadAction',  '_locale' => 'fr',));
                    }

                    // fr__RG__ibrows_newsletter_statistic_show
                    if (0 === strpos($pathinfo, '/newsletters/statistic/show') && preg_match('#^/newsletters/statistic/show/(?P<newsletterId>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fr__RG__ibrows_newsletter_statistic_show')), array (  '_controller' => 'NewslettersBundle\\Controller\\StatisticController::showAction',  '_locale' => 'fr',));
                    }

                }

                // fr__RG__ibrows_newsletter_generate_mail_jobs
                if ('/newsletters/generate/mailjobs' === $pathinfo) {
                    return array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterController::generateMailJobsAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_generate_mail_jobs',);
                }

                if (0 === strpos($pathinfo, '/newsletters/render/show')) {
                    // fr__RG__ibrows_newsletter_render_overview
                    if (preg_match('#^/newsletters/render/show/(?P<mandantHash>[^/]++)/(?P<newsletterHash>[^/]++)/(?P<subscriberHash>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fr__RG__ibrows_newsletter_render_overview')), array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterRenderingController::showAction',  '_locale' => 'fr',));
                    }

                    // fr__RG__ibrows_newsletter_render_design
                    if (0 === strpos($pathinfo, '/newsletters/render/show/design') && preg_match('#^/newsletters/render/show/design/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fr__RG__ibrows_newsletter_render_design')), array (  '_controller' => 'NewslettersBundle\\Controller\\NewsletterRenderingController::showDesignPreviewAction',  '_locale' => 'fr',));
                    }

                }

                // fr__RG__ibrows_newsletter_provider_view_add
                if ('/newsletters/provider/view/add' === $pathinfo) {
                    return array (  '_controller' => 'NewslettersBundle\\Controller\\ProviderController::editViewAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_provider_view_add',);
                }

                if (0 === strpos($pathinfo, '/newsletters/provider/block')) {
                    // fr__RG__ibrows_newsletter_blockmetadata_edit
                    if ('/newsletters/provider/blockmetadataedit' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\ProviderController::blockmetadataeditAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_blockmetadata_edit',);
                    }

                    // fr__RG__ibrows_newsletter_provider_block_position_update
                    if ('/newsletters/provider/blockposition/update' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\ProviderController::blockPositionUpdateAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_provider_block_position_update',);
                    }

                    // fr__RG__ibrows_newsletter_provider_block_remove
                    if ('/newsletters/provider/block/remove' === $pathinfo) {
                        return array (  '_controller' => 'NewslettersBundle\\Controller\\ProviderController::blockRemoveAction',  '_locale' => 'fr',  '_route' => 'fr__RG__ibrows_newsletter_provider_block_remove',);
                    }

                }

                // fr__RG__ibrows_newsletter_unsubscribe
                if (0 === strpos($pathinfo, '/newsletters/unsubscribe/do') && preg_match('#^/newsletters/unsubscribe/do/(?P<mandantHash>[^/]++)/(?P<newsletterHash>[^/]++)/(?P<subscriberHash>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'fr__RG__ibrows_newsletter_unsubscribe')), array (  '_controller' => 'NewslettersBundle\\Controller\\UnsubscribeController::unsubscribeAction',  '_locale' => 'fr',));
                }

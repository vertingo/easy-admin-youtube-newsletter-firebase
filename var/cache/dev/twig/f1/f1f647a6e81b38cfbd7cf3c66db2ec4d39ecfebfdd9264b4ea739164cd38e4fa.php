...
class __TwigTemplate_2bcff26b8456730692ec24520883d88e2d0be22cbb9fa530f86e6fdeaa1dfcc9 extends Twig_Template
{
...
";
    ...
    public function block_actions($context, array $blocks = array())
    {
        ...
        echo "\"
                       ...
                       accept=\"";
        // line 51
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute(($context["fileManager"] ?? null), "configuration", array(), "any", false, true), "accept", array(), "any", true, true)) ? ($this->getAttribute($this->getAttribute(($context["fileManager"] ?? $this->getContext($context, "fileManager")), "configuration", array()), "accept", array())) : ((($this->getAttribute(($context["fileManager"] ?? $this->getContext($context, "fileManager")), "type", array())) ? ($this->env->getExtension('Artgris\Bundle\FileManagerBundle\Twig\FileTypeExtension')->accept($this->getAttribute(($context["fileManager"] ?? $this->getContext($context, "fileManager")), "type", array()))) : ("")))), "html", null, true);
        echo "\">
            </span>
    ...
    public function block_display($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute(($context["fileManager"] ?? $this->getContext($context, "fileManager")), "view", array()) != "list")) {
            // line 75
            echo "                        ";
            echo $this->env->getExtension('Artgris\Bundle\FileManagerBundle\Twig\OrderExtension')->order($this->env, ($context["fileManager"] ?? $this->getContext($context, "fileManager")), "name");
            echo "
                        ";
            // line 76
            echo $this->env->getExtension('Artgris\Bundle\FileManagerBundle\Twig\OrderExtension')->order($this->env, ($context["fileManager"] ?? $this->getContext($context, "fileManager")), "date");
            echo "
                        ";
            // line 77
            echo $this->env->getExtension('Artgris\Bundle\FileManagerBundle\Twig\OrderExtension')->order($this->env, ($context["fileManager"] ?? $this->getContext($context, "fileManager")), "size");
            echo "
                        ";
            // line 78
            echo $this->env->getExtension('Artgris\Bundle\FileManagerBundle\Twig\OrderExtension')->order($this->env, ($context["fileManager"] ?? $this->getContext($context, "fileManager")), "dimension");
            echo "
                    ";
        }
        // line 80
